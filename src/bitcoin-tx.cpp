...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " baetcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  baetcoin-tx [options] <hex-tx> [commands]  Update hex-encoded baetcoin transaction\n" +
            "or:     baetcoin-tx [options] -create [commands]   Create hex-encoded baetcoin transaction\n" +
            "\n";
