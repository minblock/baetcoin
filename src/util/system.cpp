...
const char * const BITCOIN_CONF_FILENAME = "baetcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "baetcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/baetcoin";
#else
    // Unix
    return pathRet / ".baetcoin";
#endif
#endif
}
