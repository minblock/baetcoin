...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting latoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1586007898, 3510459, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xeb998223e01d679e401719b67b8eb30a35967a09f307f206706c4600a9cc055b"));
        assert(genesis.hashMerkleRoot == uint256S("0x8559ced582745da776fab09f74d61d796a8467dfe07ea80ff325a080aebadd08"));
        ...
        vSeeds.emplace_back("seed-a.baetcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.baetcointools.com");
        vSeeds.emplace_back("dnsseed.baetcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 549404, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x7ccc6ac50e20c7a3f6df2eb98467fd136bd4b7880f71d1bfbab4b28f44210c4c"));
        assert(genesis.hashMerkleRoot == uint256S("0x8559ced582745da776fab09f74d61d796a8467dfe07ea80ff325a080aebadd08"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.baetcointools.com");
        vSeeds.emplace_back("seed-b.baetcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xd5dbbf6c70df9f34e4ef0b517528de7a473c7ce120775e6f0b34cd909a43369c"));
        assert(genesis.hashMerkleRoot == uint256S("0x8559ced582745da776fab09f74d61d796a8467dfe07ea80ff325a080aebadd08"));
