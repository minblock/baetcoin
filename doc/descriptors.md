# Support for Output Descriptors in baetcoin Core

Since baetcoin Core v0.17, there is support for Output Descriptors. This is a
...
on baetcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing baetcoin Core wallets, a convenience function `combo` is
