...
"""Verify that starting baetcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start baetcoin with -h for help text")
        ...
        self.log.info("Start baetcoin with -version for version information")
        ...
        self.log.info("Start baetcoind with -fakearg to make sure it does not start")
